        ...
        <div class="page-title-wrapper">
            ...
            <div class="page-title-actions">
                <div class="d-inline-block dropdown">
                    ...
                    <a class="btn btn-info btn-sm" href="{{ route('admin.slider.item.create-slide',$slider->id) }}">
                        ...
                        <tbody>
                            @foreach($items as $key=>$item)
                                <tr>
                                    ...
                                    <td class="text-left">
                                        <a class="btn btn-info btn-sm" href="{{ route('admin.slider.item.edit-slide',['id'=>$slider->id,'itemId'=>$item->id]) }}"><i
                                                class="fas fa-edit"></i>
                                            <span>Edit</span>
                                        </a>
                                        ...
                                        <form id="delete-form-{{ $item->id }}"
                                              action="{{ route('admin.slider.item.destroy-slide',['id'=>$slider->id,'itemId'=>$item->id]) }}" method="POST"
                                              style="display: none;">
                                            @csrf()
                                            @method('DELETE')
                                        </form>
